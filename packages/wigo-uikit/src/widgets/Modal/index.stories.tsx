...
export const DisableOverlayClick: React.FC<React.PropsWithChildren<unknown>> = () => {
...
export const WithCustomHeader: React.FC<React.PropsWithChildren<unknown>> = () => {
...
export const ReactingToOusideChanges: React.FC<React.PropsWithChildren<unknown>> = () => {
