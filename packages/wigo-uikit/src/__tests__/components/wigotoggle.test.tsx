...
import WigoToggle from "../../components/WigoToggle/WigoToggle";

const handleChange = jest.fn();

it("renders correctly", () => {
  const { asFragment } = renderWithTheme(<WigoToggle checked onChange={handleChange} scale="md" />);
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c0 .wigo:nth-child(3):before,
    .c0 .wigo:nth-child(3):after {
      content: "";
      position: absolute;
      background: #ef8927;
      border-radius: 20px;
    ...
    .c1:checked + label .wigos {
      -webkit-transform: translateX(24px);
      -ms-transform: translateX(24px);
      transform: translateX(24px);
    }

    .c1:checked + label .wigo:nth-child(1) {
      background: #e27c31;
      box-shadow: 0 1.5px 0 1.5px #fbbe7c;
    ...
    .c1:checked + label .wigo:nth-child(2) {
    ...
    .c1:checked + label .wigo:nth-child(3) {
      -webkit-transform: scale(1);
      -ms-transform: scale(1);
      transform: scale(1);
...
it("renders correctly scale sm", () => {
  const { asFragment } = renderWithTheme(<WigoToggle checked onChange={handleChange} scale="sm" />);
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      .c0 {
      position: relative;
