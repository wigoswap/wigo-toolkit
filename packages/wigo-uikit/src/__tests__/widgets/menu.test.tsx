...
it("renders correctly", () => {
  const { asFragment } = renderWithTheme(
    <BrowserRouter>
      <Menu
        ...
        setLang={noop}
        currentLang="en-US"
        wigoPriceUsd={0.23158668932877668}
        links={menuConfig}
      >
        body
      </Menu>
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c3:hover:not(:disabled):not(.wigo-button--disabled):not(.wigo-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c3:active:not(:disabled):not(.wigo-button--disabled):not(.wigo-button--disabled) {
      opacity: 0.85;
    ...
    .c37:hover:not(:disabled):not(.wigo-button--disabled):not(.wigo-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c37:active:not(:disabled):not(.wigo-button--disabled):not(.wigo-button--disabled) {
      opacity: 0.85;
      -webkit-transform: translateY(1px);
      -ms-transform: translateY(1px);
      transform: translateY(1px);
    ...
    .c44:hover:not(:disabled):not(.wigo-button--disabled):not(.wigo-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c44:active:not(:disabled):not(.wigo-button--disabled):not(.wigo-button--disabled) {
      opacity: 0.85;
      -webkit-transform: translateY(1px);
      -ms-transform: translateY(1px);
      transform: translateY(1px);
                ...
                >
                  ...
                  >
                    <circle
                      cx="45"
                      cy="45"
                      fill="url(#paint0_linear_wigoround)"
                      r="45"
                    />
                    <path
                      clip-rule="evenodd"
                    ...
                    <path
                      ...
                      fill="url(#paint1_linear_wigoround)"
                      fill-rule="evenodd"
                    />
                    <path
                      clip-rule="evenodd"
