...
export interface WigoToggleProps extends InputHTMLAttributes<HTMLInputElement> {
  scale?: Scales;
  checked?: boolean;
}
...
export const scaleKeys = {
  ...
  wigoThickness: "wigoThickness",
  wigoTwoOffset: "wigoTwoOffset",
  wigoThreeOffset: "wigoThreeOffset",
  butterTop: "butterTop",
