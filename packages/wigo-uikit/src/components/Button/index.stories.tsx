...
export const Anchors: React.FC<React.PropsWithChildren<unknown>> = () => {
  return (
    <>
      <Box mb="32px">
        {Object.values(variants).map((variant) => {
      ...
      <Box>
        <Button as="a" href="https://wigoswap.io" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://wigoswap.io" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
...
export const Variants: React.FC<React.PropsWithChildren<unknown>> = () => {
  return (
    <Box width="640px">
      <BrowserRouter>
        <Row>
...
export const Expandable: React.FC<React.PropsWithChildren<unknown>> = () => {
