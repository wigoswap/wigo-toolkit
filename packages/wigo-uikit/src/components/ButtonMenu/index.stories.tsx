...
export const AsLinks: React.FC<React.PropsWithChildren<unknown>> = () => {
  return (
    <Row>
      <ButtonMenu activeIndex={0}>
        <ButtonMenuItem as="a" href="https://wigoswap.io">
          Link 1
        </ButtonMenuItem>
        <ButtonMenuItem as="a" href="https://wigoswap.io">
          Link 2
...
export const DisabledMenu: React.FC<React.PropsWithChildren<unknown>> = () => {
  const [index, setIndex] = useState(0);
  const [index1, setIndex1] = useState(1);
...
export const FullWidthMenu: React.FC<React.PropsWithChildren<unknown>> = () => {
  const [index, setIndex] = useState(0);
