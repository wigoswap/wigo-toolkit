...
export const WithSelector: React.FC<React.PropsWithChildren<unknown>> = () => {
...
export const Document: React.FC<React.PropsWithChildren<unknown>> = () => {
...
export const AdjustDistance: React.FC<React.PropsWithChildren<unknown>> = () => {
...
export const AdjustSize: React.FC<React.PropsWithChildren<unknown>> = () => {
...
export const AdjustNumberOfParticles: React.FC<React.PropsWithChildren<unknown>> = () => {
...
export const DisableUnderCondition: React.FC<React.PropsWithChildren<unknown>> = () => {
  const disableWhen = () => {
    const date = new Date();
...
export const StopAndStart: React.FC<React.PropsWithChildren<unknown>> = () => {
