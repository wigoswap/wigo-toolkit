...
class WigoProfileSdk {
   ...
   * API repo - https://github.com/wigoswap/wigo-profile-api
   */
   ...
   * Contract repo - https://github.com/wigoswap/wigo-contracts/tree/master/projects/profile-nft-gamification
   */
   ...
   * from WigoProfile contract.
   * NFT's wiggyId is retrieved from WigoWiggies contract and mapped to static NFT data stored in constant.
   * Contracts repo - https://github.com/wigoswap/wigo-contracts/tree/master/projects/profile-nft-gamification
   */
  getProfile = async (address: string): Promise<GetProfileResponse> => {
    try {
      ...
      if (isActive) {
        ...
        const avatar = nft ? `https://wigoswap.io/images/nfts/${nft.images.sm}` : undefined;
        ...
        Cookies.set(
          ...
          { domain: "wigoswap.io", secure: true, expires: 30 }
        );
      }
