...
import currentWigoswapDefaultList from "../lists/wigoswap-default.json";
import currentWigoswapExtendedtList from "../lists/wigoswap-extended.json";
import currentWigoswapTop15List from "../lists/wigoswap-top-15.json";
import currentWigoswapTop100tList from "../lists/wigoswap-top-100.json";
import { buildList, VersionBump } from "../src/buildList";

const currentLists = {
  "wigoswap-default": currentWigoswapDefaultList,
  "wigoswap-extended": currentWigoswapExtendedtList,
  "wigoswap-top-100": currentWigoswapTop100tList,
  "wigoswap-top-15": currentWigoswapTop15List,
};
...
const pathToImages = process.env.CI
  ? path.join(process.env.GITHUB_WORKSPACE, "packages", "wigo-lists", "lists", "images")
...
expect.extend({
  ...
  toBeValidLogo(token) {
    ...
    const refersToLocalLogo = token.logoURI === `https://tokens.wigoswap.io/images/${token.address}.png`;
...
describe.each([["wigoswap-default"], ["wigoswap-extended"], ["wigoswap-top-100"], ["wigoswap-top-15"]])(
  "buildList %s",
  (listName) => {
