...
const blacklist: string[] = [
  ...
  "0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", // WIGO
  "0xe9e7cea3dedca5984780bafc599bd69add087d56", // BUSD
  "0x55d398326f99059fF775485246999027B3197955", // USDT
  "0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c", // BTCB
  "0x2170ed0880ac9a755fd29b2688956bd959f933f8", // ETH
  "0xc9849e6fdb743d08faee3e34dd2d1bc69ea11a51", // WIGGY
...
/**
 * Fetch Top100 Tokens traded on WigoSwap v2, ordered by trading volume,
...
const getTokenLogo = (address: string): string => {
  ...
  if (logoFiles.includes(`${address}.png`)) {
    return `https://tokens.wigoswap.io/images/${address}.png`;
  }
...
const main = async (): Promise<void> => {
  try {
    ...
    const tokenListPath = `${path.resolve()}/src/tokens/wigoswap-top-100.json`;
